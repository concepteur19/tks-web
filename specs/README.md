...
| 004 | `service-selection` | Store nanostores persistant, `AddToStay`, stepper, badge, drawer desktop, page `/sejour`, toasts, purge et migrations | FR-SEL-*, FR-I18N-5 | 003 | Quantité véhicules ou jours par service transport (D1) — hypothèse documentée |
