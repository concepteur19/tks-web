# TKS® — Brief de design, Direction B « Nuit tropicale »
...
Sombre et élégante, un tourisme haut de gamme mais accessible.

- Couleurs : un vert forêt très foncé et une nuit profonde pour les fonds, du blanc cassé pour le texte, un doré sable pour les accents et les prix. Le bouton WhatsApp garde le vert de la marque WhatsApp.
- Typographies : une serif contemporaine pour les titres, un sans-serif neutre pour le texte courant, et une écriture manuscrite fine uniquement pour la signature « Kribi is a feeling ».
- Formes : coins peu arrondis, cartes délimitées par une bordure fine plutôt que par une ombre, photographies pleine largeur avec un dégradé sombre, lettrage espacé pour les intertitres.
...
1. Barre de navigation fixe : logo texte « TKS® » à gauche, sélecteur « FR | EN », icône « Mon séjour » avec une pastille indiquant 0, bouton WhatsApp vert, menu hamburger donnant Transport, Tourisme, Livraison, À propos, Contact.
...
2. Deux champs optionnels côte à côte : « Dates du séjour » et « Nombre de voyageurs ». Sous eux, un rappel discret : « Ajoute tes dates pour une réponse plus rapide ».
3. Quatre lignes de sélection. Chaque ligne porte une vignette photo, le nom, la quantité avec son libellé, le prix de la ligne, un sélecteur de quantité compact et une icône de suppression :
...
Pas d'avis ni de notes clients. Pas de formulaire de contact. Pas de page de formules ou de packs. Pas d'hébergements. Pas de prix en euros. Pas de paiement, pas de connexion, pas de bandeau de cookies.

## 8. Nommage et variables

- Nomme les écrans « 01 Accueil mobile », « 03 Fiche mobile », « 04 Mon séjour mobile ».
